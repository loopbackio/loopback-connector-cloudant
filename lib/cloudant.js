    ...
    if (spec) {
      switch (spec) {
        case 'between':
          ...
          break;
        case 'inq':
          query[k] = {$in: cond.map(function(x) { return x; })};
          break;
        case 'nin':
          query[k] = {$nin: cond.map(function(x) { return x; })};
          break;
        case 'neq':
          query[k] = {$ne: cond};
          break;
 ...
 * @param {Function} [cb] The cb function
 */
function extendDocs(rst, docs, cb) {
