...
Cloudant.prototype.destroyAll = function destroyAll(model, where, options, cb) {
  ...
  self.all(model, {where: where, limit: self.getLimit()}, {raw: true},
    function(err, docs) {
      if (err) return cb(err, null);
...
Cloudant.prototype.count = function count(model, where, options, cb) {
  ...
  var self = this;
  self.all(model, {where: where, limit: self.getLimit()}, {},
    function(err, docs) {
...
Cloudant.prototype.getLimit = function(limit) {
  return limit || this.getGlobalLimit();
};

Cloudant.prototype.getGlobalLimit = function() {
